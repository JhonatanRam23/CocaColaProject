...
namespace VenadoProject.Controllers
{
    public class productoesController : Controller
    {
        ...
        {
            var producto = db.producto.Include(p => p.clase_producto);
        ...
        {
            ViewBag.clase = new SelectList(db.clase_producto, "id", "nombre");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,clase,unidad_medidad")] producto producto)
        {
            if (ModelState.IsValid)
            {
